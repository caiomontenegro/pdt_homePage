...
const posts = [
  {
    title: 'A bolha das criptos',
    href: '#',
    category: { name: 'Artigo', href: '#', color: 'bg-indigo-100 text-indigo-800' },
    description:
  ...
  {
    title: 'Gerencimento de risco básico',
    href: '#',
    category: { name: 'Estudos', href: '#', color: 'bg-green-100 text-green-800' },
