      ...
      <div class="bg-white py-40 sm:py-10 px-8 sm:ml-10 shadow sm:rounded-lg sm:px-10 sm:w-10/12 h-screen sm:h-auto" @click="toggleModal">
        ...
        <form class="space-y-6" action="#" method="POST">
          <div>
            ...
            <div class="mt-1">
              <input
                ...
                autocomplete="email"
                required=""
                class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-emerald-400 focus:border-emerald-400 sm:text-sm"
              />
            </div>
          </div>
          <div>
          ...
          <div>
            <button
              type="submit"
              class="w-full flex justify-center py-2 px-4 border-2 border-blue-400 rounded-md shadow-sm text-sm font-medium text-white bg-gray-700 hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-offset-2"
            >
              Entrar
            </button>
          </div>
        ...
        <div class="mt-6">
          <div class="relative">
            ...
            <div class="relative flex justify-center text-sm">
              <span class="px-2 bg-white text-gray-500"> Ou acesse com: </span>
            </div>
          </div>
